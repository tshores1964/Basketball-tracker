...
function buildLeaderboard() {
  try {
    ...
    const kingPoints=roster.map(function(n){const w=playerWeightedMakes(n,weeks),t=playerTotals(n,weeks);return{name:n,val:Math.round(w*10)/10,sub:t.m+" made \u00b7 "+(t.pct===null?"--":t.pct+"%")};}).filter(function(p){return p.val>0;}).sort(function(a,b){return b.val-a.val;});
